      ...
      <div className="card" id="rec-card">
        <div className="card-header text-center">
          ...
          <p className="subtitle">
            Please provide the details of the software and tasks you’ll be performing, and we’ll recommend the best hardware configuration.
          </p>
        </div>
        <div className="card-body">
          <form onSubmit={handleSubmit} className="input-question-form">
            <div className="form-group">
              <label htmlFor="question" className="form-label" id="rec-form">
              ...
              <textarea
                ...
                value={inputQuestion}
                onChange={handleInputChange} // Update the state but don't trigger APIs
            ...
            <button type="submit" className="btn-primary w-50" id="rec-btn">
              Get Recommendations
            </button>
          </form>
        </div>
